...
function store:create_buttons()
    ...
    local menu_y =      love.graphics.getHeight() * 0.15
...
function store:draw()
    ...
    for key, button in pairs(self.buttons) do
        ...
        -- draw price
        love.graphics.printf(item.prices[item.state + 1], button.price.x, button.price.y, button.price.width)
